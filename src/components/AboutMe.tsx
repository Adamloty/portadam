		...
		>
			<div className={styles.imageContainer}>
				<motion.div
					...
					<Image src="/011.png" alt="About Me" width={600} height={610} />
				</motion.div>
			</div>
			<motion.div
				initial={{ y: 70 }}
						...
						<div className={styles.ctaContainer}>
							<div className={styles.cta}>
								...
								<div className={styles.socialIcons}>
									...
									<a
										href="https://www.facebook.com/profile.php?id=61553477099228"
									...
									<a
										href="https://www.instagram.com/ada_m33640/"
...
const SocialIcon: React.FC<{ href: string; name: string }> = ({
	href,
	name,
}) => (
